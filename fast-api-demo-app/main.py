...
uri = "mongodb+srv://snglakshat:Akshat123@cluster0.5ujyyht.mongodb.net/fast_api"
...
async def read_item(month: int, year:int, userToken: str | None = None):
    ...
    myclient = pymongo.MongoClient("mongodb+srv://snglakshat:Akshat123@cluster0.5ujyyht.mongodb.net/fast_api")
